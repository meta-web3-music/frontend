...
export const monetize = async (contractAddr: string, tokenId: bigint, metadataUri: string, publicClient: PublicClient, walletClient: WalletClient) => {
    ...
    try {
        ...
        await adNft.write.
            openForMonetize([contractAddr as `0x${string}`,
                tokenId,
                metadataUri], { account: walletClient.account, chain: walletClient.chain })
