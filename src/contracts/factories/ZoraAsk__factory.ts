...
import type { ZoraAsk, ZoraAskInterface } from "../ZoraAsk";
...
export class ZoraAsk__factory {
  static readonly abi = _abi;
  static createInterface(): ZoraAskInterface {
    return new utils.Interface(_abi) as ZoraAskInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ZoraAsk {
    return new Contract(address, _abi, signerOrProvider) as ZoraAsk;
  }
}
